...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_user_group(self, group_queryset):
        ret = []
    ...
    def get_user_gid(self, group_queryset):
        ret = []
        for group in group_queryset:
            ret.append(
                group.id,
    ...
    def to_representation(self, instance):
        groupinfo = self.get_user_group(instance.groups.all())
        gid  = self.get_user_gid(instance.groups.all())
